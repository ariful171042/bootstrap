  ...
  for (let i = 0; i < moviesArr.length; i++) {
    ...
    movieElement.innerHTML = `
            ...
            <div class="card-body">
              ...
              <h2 class="text-danger fw-bold">${moviesArr[i].ticketPrice} ৳</h2>
              <button class="btn btn-dark shadow-none fw-bold book-tiket">
                Book Tickets
              </button>
            </div> `;
...
function displayModal() {
  const bookTicekets = document.querySelectorAll(".book-tiket");
    ...
    bookTicekets[i].addEventListener("click", function () {
      for (let j = 0; j < moviesArr.length; j++) {
        if (i === j) {
          ...
          <h5><strong>Sub Total:</strong> ${mot} ৳</h5>
